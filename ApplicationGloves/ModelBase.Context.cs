...
namespace ApplicationGloves
{
    ...
    public partial class ShopGlovesEntities : DbContext
    {
        private static ShopGlovesEntities _context;
        public ShopGlovesEntities()
            : base("name=ShopGlovesEntities")
        {
        }

        public static ShopGlovesEntities GetContext()
        {
            if (_context == null)
                _context = new ShopGlovesEntities();
